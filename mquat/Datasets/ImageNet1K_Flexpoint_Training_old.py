...
def start(model_class, quantize_method, LR_FACTOR, total_bits, with_activation, EPOCHS, starting_checkpoint, KEEP_FACTOR, batch_size=32, adder=None, fused_bnorm=True):
    ...
    print("model_quant_desc", model_quant_desc)
    ...
    model.fit(train_dataset, epochs=EPOCHS, validation_data=test_dataset, verbose=1, use_multiprocessing=True,
              validation_freq=1, callbacks=[LocalCallbacks(), csv_logger])
